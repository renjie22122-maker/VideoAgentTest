...
export async function submitMiniMax(p:Project,j:Job,base:string,model:string,key:string,request:Request){
 ...
 const input={model,content,duration:shot.duration,resolution:'768P',ratio:mode==='first'||mode==='first_last'?'adaptive':p.ratio};
